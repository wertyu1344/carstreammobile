...
class ScreenCaptureInitPage extends StatefulWidget {
  @override
  _ScreenCaptureInitPageState createState() =>
      new _ScreenCaptureInitPageState();
}

class _ScreenCaptureInitPageState extends State<ScreenCaptureInitPage> {
  final TextEditingController _appGroupEdController =
      ...
      return Column(children: [
        ...
        Row(
          children: <Widget>[
            ...
            GestureDetector(
              child: Container(
                  width: 40.0, height: 40.0, child: Icon(Icons.info_outline)),
              onTap: () {
