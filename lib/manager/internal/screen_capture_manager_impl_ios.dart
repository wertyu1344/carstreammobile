...
class ScreenCaptureManagerImplIOS extends ScreenCaptureManager {
  ...
  Future<void> setParamsForVideoConfig(int videoWidth, int videoHeight,
    ...
    await SharedPreferenceAppGroup.setInt(
        "ZG_SCREEN_CAPTURE_VIDEO_SIZE_WIDTH", videoWidth);
    await SharedPreferenceAppGroup.setInt(
        "ZG_SCREEN_CAPTURE_VIDEO_SIZE_HEIGHT", videoHeight);
    await SharedPreferenceAppGroup.setInt(
        "ZG_SCREEN_CAPTURE_SCREEN_CAPTURE_VIDEO_FPS", videoFPS);
    await SharedPreferenceAppGroup.setInt(
        "ZG_SCREEN_CAPTURE_SCREEN_CAPTURE_VIDEO_BITRATE_KBPS",
        videoBitrateKBPS);
  }
  ...
  Future<void> setParamsForStartLive(
    ...
    await SharedPreferenceAppGroup.setString(
        "ZG_SCREEN_CAPTURE_USER_ID", userID);
    await SharedPreferenceAppGroup.setString(
        "ZG_SCREEN_CAPTURE_USER_NAME", userName);
    await SharedPreferenceAppGroup.setString(
        "ZG_SCREEN_CAPTURE_ROOM_ID", roomID);
    await SharedPreferenceAppGroup.setString(
        "ZG_SCREEN_CAPTURE_STREAM_ID", streamID);
  }
}
*/
