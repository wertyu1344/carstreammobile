...
abstract class ScreenCaptureManager {
  ...
  Future<void> setParamsForCreateEngine(
      int appID, String appSign, bool onlyCaptureVideo);

  Future<void> setParamsForVideoConfig(
      int videoWidth, int videoHeight, int videoFPS, int videoBitrateKBPS);

  Future<void> setParamsForStartLive(
      String roomID, String userID, String userName, String streamID);
